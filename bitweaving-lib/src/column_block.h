...
class ColumnBlock {
 public:
   ...
   */
  virtual Status Resize(size_t num) = 0;
   ...
   * @return A Status object to indicate success or failure.
   */
  virtual Status Bulkload(const Code *codes, size_t num, TupleId start_tuple_id) = 0;
   ...
   * @return A Status object to indicate success or failure.
   */
  virtual Status GetCode(TupleId pos, Code *code) const = 0;
