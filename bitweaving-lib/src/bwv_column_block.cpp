            ...
            if (kNumBitsPerCode >= kNumBitsPerGroup * 5 && ((mask_equal1 != 0) |  (mask_equal2 != 0))) {
              ...
              if (kNumBitsPerCode >= kNumBitsPerGroup * 6 && ((mask_equal1 != 0) |  (mask_equal2 != 0))) {
                ScanIteration_between<5>(segment_offset, mask_equal1,  mask_equal2, mask_less,
                                      mask_greater, literal1_bit_ptr, literal2_bit_ptr);
                if (kNumBitsPerCode >= kNumBitsPerGroup * 7 && ((mask_equal1 != 0) |  (mask_equal2 != 0))) {
                  ScanIteration_between<6>(segment_offset, mask_equal1,  mask_equal2, mask_less,
                                        mask_greater, literal1_bit_ptr, literal2_bit_ptr);
                  if (kNumBitsPerCode >= kNumBitsPerGroup * 8 && ((mask_equal1 != 0) |  (mask_equal2 != 0))) {
 ...
 */
template class BwVColumnBlock<1> ;
template class BwVColumnBlock<2> ;
template class BwVColumnBlock<3> ;
template class BwVColumnBlock<4> ;
template class BwVColumnBlock<5> ;
template class BwVColumnBlock<6> ;
template class BwVColumnBlock<7> ;
template class BwVColumnBlock<8> ;
template class BwVColumnBlock<9> ;
template class BwVColumnBlock<10> ;
template class BwVColumnBlock<11> ;
template class BwVColumnBlock<12> ;
template class BwVColumnBlock<13> ;
template class BwVColumnBlock<14> ;
template class BwVColumnBlock<15> ;
template class BwVColumnBlock<16> ;
template class BwVColumnBlock<17> ;
template class BwVColumnBlock<18> ;
template class BwVColumnBlock<19> ;
template class BwVColumnBlock<20> ;
template class BwVColumnBlock<21> ;
template class BwVColumnBlock<22> ;
template class BwVColumnBlock<23> ;
template class BwVColumnBlock<24> ;
template class BwVColumnBlock<25> ;
template class BwVColumnBlock<26> ;
template class BwVColumnBlock<27> ;
template class BwVColumnBlock<28> ;
template class BwVColumnBlock<29> ;
template class BwVColumnBlock<30> ;
template class BwVColumnBlock<31> ;
template class BwVColumnBlock<32> ;
