 ...
 */
template class BwHColumnBlock<1> ;
template class BwHColumnBlock<2> ;
template class BwHColumnBlock<3> ;
template class BwHColumnBlock<4> ;
template class BwHColumnBlock<5> ;
template class BwHColumnBlock<6> ;
template class BwHColumnBlock<7> ;
template class BwHColumnBlock<8> ;
template class BwHColumnBlock<9> ;
template class BwHColumnBlock<10> ;
template class BwHColumnBlock<11> ;
template class BwHColumnBlock<12> ;
template class BwHColumnBlock<13> ;
template class BwHColumnBlock<14> ;
template class BwHColumnBlock<15> ;
template class BwHColumnBlock<16> ;
template class BwHColumnBlock<17> ;
template class BwHColumnBlock<18> ;
template class BwHColumnBlock<19> ;
template class BwHColumnBlock<20> ;
template class BwHColumnBlock<21> ;
template class BwHColumnBlock<22> ;
template class BwHColumnBlock<23> ;
template class BwHColumnBlock<24> ;
template class BwHColumnBlock<25> ;
template class BwHColumnBlock<26> ;
template class BwHColumnBlock<27> ;
template class BwHColumnBlock<28> ;
template class BwHColumnBlock<29> ;
template class BwHColumnBlock<30> ;
template class BwHColumnBlock<31> ;
template class BwHColumnBlock<32> ;
